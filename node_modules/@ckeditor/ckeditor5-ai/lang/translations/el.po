...
msgstr "Αυτό το πεδίο δεν μπορεί να είναι κενό."
...
msgstr "Η έναρξη της συνομιλίας δεν ήταν δυνατή. Βεβαιωθείτε ότι είστε συνδεδεμένοι στο διαδίκτυο και προσπαθήστε ξανά."
...
msgstr "Αποτυχία μεταφόρτωσης αρχείων: %0. Προσπαθήστε ξανά."
...
msgstr "Τρέχον πλαίσιο προτροπής"
...
msgstr "Επιστροφή στις επιλογές πλαισίου προτροπής"
...
msgstr "Μη έγκυρος τύπος δεδομένων πλαισίου για τον επιλεγμένο πόρο."
...
msgstr "Μη υποστηριζόμενος τύπος πόρου. Υποστηρίζονται μόνο αρχεία και URL."
...
msgstr "Πληκτρολογήστε μια έγκυρη URL."
...
msgstr "Ενεργοποίηση αναζήτησης ιστού"
...
msgstr "Απενεργοποίηση αναζήτησης ιστού"
...
msgstr "Ενεργοποίηση συλλογισμού"
...
msgstr "Απενεργοποίηση συλλογισμού"
...
msgstr "Η ΑΙ ετοιμάζει μια απάντηση..."
...
msgstr "Η ΑΙ πραγματοποιεί αναζήτηση στο διαδίκτυο για να σας παρέχει την πιο ακριβή απάντηση..."
...
msgstr "Η AI διεξάγει έρευνα εις βάθος για να σας παρέχει την πιο ακριβή απάντηση..."
...
msgstr "Η AI διεξάγει έρευνα εις βάθος και πραγματοποιεί αναζήτηση στο διαδίκτυο για να σας παρέχει την πιο ακριβή απάντηση..."
...
msgstr "Έγινε αναζήτηση στο διαδίκτυο για πληροφορίες"
...
msgstr "Σκέφτηκα για λίγα λεπτά"
...
msgstr "Ρωτήστε την AI οτιδήποτε (η αναζήτηση ιστού είναι ενεργοποιημένη)..."
...
msgstr "Ρωτήστε την AI οτιδήποτε (ο συλλογισμός είναι ενεργοποιημένος)..."
...
msgstr "Προτεινόμενο περιεχόμενο"
...
msgstr[0] "Εμφάνιση αλλαγής στο κείμενο"
msgstr[1] "Εμφάνιση αλλαγών στο κείμενο"
...
msgstr[0] "Εισαγωγή πρότασης"
msgstr[1] "Εισαγωγή προτάσεων"
...
msgstr "Η αλλαγή έχει εφαρμοστεί ήδη"
...
msgstr "Ξεκινήστε μια νέα συνομιλία για να αλλάξετε μοντέλο"
...
msgstr[0] "Εφαρμογή πρότασης"
msgstr[1] "Εφαρμογή όλων των προτάσεων"
...
msgstr "Δεν είναι δυνατή η φόρτωση πόρων από το %0. Προσπαθήστε ξανά."
...
msgstr "Η τεχνητή νοημοσύνη (ΑΙ) μπορεί να κάνει λάθη. Ελέγξτε ξανά τις απαντήσεις."

msgctxt "The heading element name for AI Quick Actions."
msgid "AI_QUICK_ACTIONS_HEADING"
msgstr "Γρήγορες ενέργειες AI"
...
msgstr "Επισήμανση βασικών σημείων"
...
msgstr "Προσαρμογή με βάση το υπόλοιπο έγγραφο"
...
msgstr "Απαιτείται το πρόσθετο %0, αλλά δεν βρέθηκε."
...
msgstr "Δεν βρέθηκαν συνομιλίες που να ταιριάζουν με τον όρο \"%0\"."
...
msgstr "Το ιστορικό συνομιλιών σας είναι κενό αυτή τη στιγμή. Αφού δημιουργήσετε μερικές συνομιλίες, θα μπορείτε να τις ξαναδείτε εδώ."
...
msgstr "Θέλετε να αφαιρέσετε αυτήν τη συνομιλία;"
...
msgstr "Λυπούμαστε, δεν μπορέσαμε να αλλάξουμε το όνομα της συνομιλίας \"%0\". Προσπαθήστε ξανά σε λίγο."
...
msgstr "Λυπούμαστε, δεν μπορέσαμε να %0] τη συνομιλία \"%1\". Προσπαθήστε ξανά σε λίγο."
...
msgstr "Λυπούμαστε, δεν μπορέσαμε να διαγράψουμε τη συνομιλία \"%0\". Προσπαθήστε ξανά σε λίγο."

msgctxt "The error message displayed when loading the chat history fails."
msgid "AI_CHAT_HISTORY_ERROR_LOAD_ITEMS"
msgstr "Λυπούμαστε, δεν μπορ΄έσαμε να δημιουργήσουμε ιστορικό συνομιλιών. Προσπαθήστε ξανά σε λίγο."
...
msgstr "Παρουσιάστηκε κάποιο πρόβλημα. Προσπαθήστε ξανά σε λίγο."
...
msgstr "Ορισμένες προτάσεις δεν μπορούν να εφαρμοστούν στον επεξεργαστή, διότι το σύστημα δεν μπορεί να τις εμφανίσει σωστά."

msgctxt "The warning text displayed when the suggestion has no parts."
msgid "AI_SUGGESTION_NO_PARTS_WARNING"
msgstr "Η πρόταση δεν μπορεί να εφαρμοστεί στον επεξεργαστή, διότι το σύστημα δεν μπορεί να την εμφανίσει σωστά."
...
msgstr "Ο έλεγχος τελείωσε. Ολοκληρώστε όταν είστε έτοιμοι."
...
msgstr "Λυπούμαστε, δεν μπορέσαμε να δημιουργήσουμε σωστά ολόκληρο τον έλεγχο. Προσπαθήστε ξανά σε λίγο."
...
msgstr "Δεν ολοκληρώθηκαν όλα, αλλά τα ολοκληρωμένα στοιχεία εμφανίζονται παρακάτω."
...
msgstr "Μια ελαφριά έκδοση του GPT-5 για ταχύτερες και πιο οικονομικές απαντήσεις"

msgctxt "The description of the GPT-4.1 model."
msgid "AI_MODEL_DESCRIPTION_GPT-4.1"
msgstr "Το μοντέλο της OpenAI για αξιόπιστη συλλογιστική, ταχύτητα και ευελιξία"

msgctxt "The description of the GPT-4.1-Mini model."
msgid "AI_MODEL_DESCRIPTION_GPT-4.1-MINI"
msgstr "Μια ελαφρύτερη παραλλαγή του GPT-4.1 που εξισορροπεί την ταχύτητα και το κόστος διατηρώντας παράλληλα σταθερή ακρίβεια"

msgctxt "The description of the Claude-3-5-Haiku model."
msgid "AI_MODEL_DESCRIPTION_CLAUDE-3-5-HAIKU"
msgstr "Το γρήγορο και οικονομικό μοντέλο της Anthropic για απλούστερες εργασίες"

msgctxt "The description of the Claude-4-Sonnet model."
msgid "AI_MODEL_DESCRIPTION_CLAUDE-4-SONNET"
msgstr "Προηγμένο μοντέλο με ισχυρή συλλογιστική και αξιοπιστία για σύνθετες εργασίες"

msgctxt "The description of the Gemini-2-5-Pro model."
msgid "AI_MODEL_DESCRIPTION_GEMINI-2-5-PRO"
msgstr "Το προηγμένο μοντέλο της Google για ευέλικτη επίλυση προβλημάτων και έρευνα"

msgctxt "The description of the Gemini-2-5-Flash model."
msgid "AI_MODEL_DESCRIPTION_GEMINI-2-5-FLASH"
msgstr "Ελαφρύ μοντέλο Gemini για γρήγορες και οικονομικά αποδοτικές αλληλεπιδράσεις"
...
msgstr "Πληκτρολογήστε μια προσαρμοσμένη εντολή για να ελέγξετε το περιεχόμενο ακριβώς όπως το χρειάζεστε."
...
msgstr "Βεβαιωθείτε ότι το κείμενο είναι ρεαλιστικό και χωρίς λάθη."
...
msgstr "Βελτιώστε τη σαφήνεια και την αναγνωσιμότητα του κειμένου."
...
msgstr "Βελτιώστε τη συνολική αναγνωσιμότητα του κειμένου."
...
msgstr "Βελτιώστε το μήκος του κειμένου ώστε να ταιριάζει στις ανάγκες σας."
...
msgstr "Μεταφράστε το κείμενο σε άλλη γλώσσα."
